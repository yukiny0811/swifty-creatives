...
public class Rectangle {
    ...
    private final class VertexPoint {
        static let A: simd_float3 = simd_float3(x: -1.0, y:   1.0, z:   0.0)
        static let B: simd_float3 = simd_float3(x: -1.0, y:  -1.0, z:   0.0)
        static let C: simd_float3 = simd_float3(x:  1.0, y:  -1.0, z:   0.0)
        static let D: simd_float3 = simd_float3(x:  1.0, y:   1.0, z:   0.0)
    }
