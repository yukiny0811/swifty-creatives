...
#if os(macOS)
final class NormalRendererTests: XCTestCase {
    ...
    func testNormalRendering() async throws {
        ...
        class TestSketch: Sketch {
            ...
            override func afterCommit(texture: MTLTexture?) {
                ...
                assertSnapshot(matching: finalimage, as: .image, record: SnapshotTestUtil.isRecording, testName: "testNormalRendering")
            }
        }
